...
describe('articleDetailsSlice', () => {
  it('should fetch article service pending', () => {
    const state: DeepPartial<ArticleDetailsSchema> = { isLoading: false, error: '123' };
    expect(articleDetailsReducer(state as ArticleDetailsSchema, fetchArticleById.pending)).toEqual({
      isLoading: true,
      error: undefined,
    });
  });
  it('should fetch article service fulfilled', () => {
